...
var ITEMS=[
 ...
 {id:"MILK",        x:133,y:225,  shelf:{x:128,y:160,w:122,h:70},  rows:[299], pts:100, icon:"milk"},
...
// Outlines the active pickup's real product art on the shelf — e.g. while
// CHIPS is live, the chip bags themselves get a pulsing gold box — so the
...
function drawShelfHighlight(g,t){
  ...
  var b=it.shelf;
  var pulse=0.55+0.35*Math.sin(t*4.2);
  g.save();
  g.shadowColor="rgba(245,197,24,0.9)";
  g.shadowBlur=14;
  g.strokeStyle="rgba(245,197,24,"+pulse.toFixed(2)+")";
  g.lineWidth=4;
